...
{else}
	...
	{if $galleys}
		...
		{if $hasAccess || ($subscriptionRequired && $showGalleyLinks)}
			...
			{/if}
		{else}
			&nbsp; <a href="http://www.itergateway.org/login" target="_parent" style="display:inline-block; font-weight:bold; background-color:lightYellow; padding:5px; text-decoration:none; border:1px solid orange;">Login to Iter</a> to gain access.  This content is for Iter Subscribers Only. 
		{/if}
	{/if}
{/if}
